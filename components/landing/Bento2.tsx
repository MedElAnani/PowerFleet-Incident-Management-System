...
const bentoCardClass = cn(
  'group relative flex flex-col justify-between overflow-hidden rounded-xl bg-white dark:bg-slate-900 p-4 lg:p-6 duration-300 antialiased',
...
export default function Bento2({ className }: Bento2Props) {
  ...
  return (
    <section
      className={cn(
        'flex h-full w-full items-center justify-center px-4 py-12 font-sans antialiased',
        className,
      )}
    >
      <div className="grid w-full max-w-4xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        >
              ...
              <div className="flex h-30 items-end gap-1.5 overflow-hidden">
                {[40, 70, 45, 90, 65, 85, 35, 60, 50, 80, 55, 75].map(
                  (height, i) => (
                    <motion.div
                      key={i}
                      className="bg-emerald-500 dark:bg-emerald-500/60 w-full rounded-t-sm"
          ...
          <div className="relative z-10 flex flex-col gap-2 pt-4">
            ...
            <p className="text-muted-foreground max-w-sm text-sm">
              Monitor your entire fleet with zero-latency GPS tracking
              and perfectly accurate telemetry pipelines.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-2 pb-4">
            ...
            <p className="text-muted-foreground max-w-[200px] text-sm">
              Keep your fleet running with predictive maintenance and real-time alerts.
            </p>
          </div>
            ...
            <motion.div className="relative z-10 flex w-full flex-col gap-3 overflow-hidden">
              <div className="border-border/50 flex items-center justify-between border-b pb-2">
                ...
                <div className="flex items-center gap-1.5">
                  <motion.div
                    className="bg-emerald-500 size-1.5 rounded-full shadow-[0_0_8px_#10b981]"
                    animate={
                      hoveredCard === 2
                        ? { opacity: [1, 0.3, 1] }
                        : { opacity: 1 }
                  ...
                  />
                  <span className="text-emerald-500 text-[9px] font-bold tracking-wider uppercase">
                    100% Operational
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                {[
                  { name: 'GPS Telemetry', delay: 0.2 },
                  { name: 'Engine Diagnostics', delay: 0.5 },
                  { name: 'Dispatch API', delay: 0.8 },
                ].map((service) => (
                  <div key={service.name} className="flex flex-col gap-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <motion.span
                          className="text-emerald-500 font-mono text-[9px] drop-shadow-[0_0_4px_#10b981]"
                        ...
                        <div className="bg-muted relative h-1 w-12 overflow-hidden rounded-full">
                          <motion.div
                            className="bg-emerald-500 absolute top-0 bottom-0 left-0 shadow-[0_0_8px_#10b981]"
                            initial={{ width: '0%' }}
                            animate={
                              hoveredCard === 2
                                ? { width: '100%' }
        ...
        >
          ...
          <div className="relative z-10 flex w-full flex-1 items-start justify-center overflow-visible pt-8">
            <div className="relative flex w-full flex-col items-center">
              ...
              >
                ...
                {/* Ping Dot */}
                <motion.div 
                  className="absolute right-3 top-3 size-2 rounded-full bg-emerald-500"
                  initial={{ scale: 0 }}
              ...
              <div className="absolute top-6 flex w-full flex-col items-center justify-center pt-8">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-semibold text-foreground">Critical Engine Fault</span>
                    <span className="text-[10px] text-muted-foreground">Truck #402 - Immediate action required</span>
                  </div>
                </motion.div>
              </div>
          ...
          <div className="relative z-10 flex flex-col gap-2 pt-4">
            ...
            <p className="text-muted-foreground max-w-[200px] text-sm">
              Get notified instantly before critical vehicle failures or incidents occur on the road.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-end gap-2 pb-4">
            ...
            <p className="text-muted-foreground max-w-sm text-sm">
              Track and dispatch your vehicles nationwide with
              automated intelligent routing and real-time load balancing.
            </p>
          </div>
          ...
          <div className="relative z-10 flex w-full flex-1 items-end justify-center overflow-hidden min-h-[200px]">
            ...
            >
               <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[60%] h-[80px] rounded-[100%] bg-emerald-500/15 blur-3xl"></div>
            </motion.div>
               ...
               {[
                 ...
                 >
                   <div className="relative z-10 flex size-9 items-center justify-center rounded-full border border-border/80 bg-background shadow-sm overflow-hidden">
                     ...
                     {/* Status Dot */}
                     <motion.div 
                       className="absolute bottom-0 right-0 size-2.5 rounded-full border-[1.5px] border-background bg-emerald-500"
